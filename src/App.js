...
import PatPanel from './Patients/PatComponents/PatPanel';
...
import Security from './Patients/PatComponents/Security';
import FindDoctor from './Patients/PatComponents/FindDoctor';
import FindHospitals from './Patients/PatComponents/FindHospitals';
import Chatbot from './Patients/PatComponents/Chatbot';
...
const App = () => (
    <div>
        <Routes>
            ...
            <Route path="/panel" element={<PatPanel/>} />
            <Route path="/mednav" element={<MedNavbar/>} />
            <Route path="/services" element={<ServicesGrid/>} />
            <Route path="/services" element={<UIDepartments/>} />
            <Route path="/security" element={<Security/>} />
            <Route path="/footer" element={<Footer/>} />
            <Route path="/find-doctor" element={<FindDoctor/>} />
            <Route path="/find-hospital" element={<FindHospitals/>} />
